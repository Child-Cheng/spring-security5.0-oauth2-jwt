package com.culturalCenter.AuthorizationServer.mapper;
...
public interface UsersMapper {
    @Select("select id as id,user_name as userName,user_no as userNo,password from  users where user_name=#{username}")
